...
Công thức Hóa học đơn giản trong RStudio/Knitr (render HTML)

Do RStudio phiên bản hiện hành (v1.2.5033) xài JavaScript MathJax v2.6.1 (để file "MathJax.js" online trên host RStudio) với config không cho phép biểu diễn những công thức hóa học, hay phương trình hóa học, dù là rất đơn giản. Do vậy, chúng ta cần customize Knitr lại, để xài được phiên bản MathJax mới nhất (v3.0).

Bước 1: Config RMarkdown
...
Tham khảo thêm: https://bookdown.org/yihui/rmarkdown/html-document.html#mathjax-equations.

Bước 2: Thử nghiệm lại bằng công thức hóa học cụ thể
...
Xem thêm: http://docs.mathjax.org/en/latest/input/tex/extensions/mhchem.html.

Cũng lưu ý thêm. MathJax v3.0 biểu diễn Công thức Hóa học thông qua Extension (một đoạn JavaScript) là mhchem. Do vậy, để biểu diễn tất cả những Công thức Hóa học mà mhchem hỗ trợ, thiết nghĩ, cũng nên xem lướt qua tài liệu của chính tác giả gốc viết.

Link: https://www.ctan.org/pkg/mhchem.

---
Cái mình cần, ví dụ như là vẽ mạch vòng thơm tho, thậm chí là bàn cờ vua, hay những nốt nhạc, đồ thị dao động tắt dần (vật lí), thì có vẻ như Knitr chưa hỗ trợ ở dạng HTML (hiểu nôm na là web, để upload lên RPubs). Hic.

Hình như hàng ngàn packages loại LaTeX đều được Knitr hỗ trợ (thông qua Pandoc), nhưng chỉ dành cho dạng PDF, và chỉ upload lên một số host hơi đặc dụng mà thôi.
-->
