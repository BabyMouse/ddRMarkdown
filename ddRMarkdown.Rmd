...
**3.2.2020:** Thêm trang **Phụ lục 1: Các bảng mã**.

- Link: <a target="_parent" href="https://rpubs.com/BabyMouse/ddrEncodingTables">ddrEncodingTables</a>
...
**19.1.2020:** Khởi tạo project và upload lên `GitHub`.
...
### Phụ lục 1: Các bảng mã thường dùng: <a target="_parent" href="https://rpubs.com/BabyMouse/ddrEncodingTables">ddrEncodingTables</a> (<span class="update">3.2.2020</span>)
