...
#date: "Ngày `r format(Sys.time(), '%d %B, %Y')`22/1/2020"
date: "Ngày 22/1/2020"
output: 
  html_document: 
    df_print: kable
    ...
    pandoc_args: [
      #"--highlight-style", "_includes/haddock.theme",
      #"--syntax-definition","_template/r.xml",
      "--variable", "code_folding=show",
      "--variable", "source_embed=ddrIntroduction.Rmd",
      "--variable", "code_menu=1",
      ]
    #md_extensions: +fenced_code_blocks+backtick_code_blocks
    mathjax: null
    css:
      - "_includes/style.css"
    ...
    includes:
      in_header:
        ...
        - "_includes/header_codefolding.html"
        - "_includes/header_sourceembed.html"
